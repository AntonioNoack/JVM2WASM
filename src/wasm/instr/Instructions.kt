...
object Instructions {
    ...
    val I32ShrU = ShiftInstr("i32.shr_u", i32, BinaryOperator.SHIFT_RIGHT_UNSIGNED, Opcode.I32_SHRU) { a, b -> a.toInt().ushr(b) }
    val I32ShrS = ShiftInstr("i32.shr_s", i32, BinaryOperator.SHIFT_RIGHT_SIGNED, Opcode.I32_SHRS) { a, b -> a.toInt().shr(b) }
    val I64Shl = ShiftInstr("i64.shl", i64, BinaryOperator.SHIFT_LEFT, Opcode.I64_SHL) { a, b -> a.toLong().shl(b) }
    val I64ShrU = ShiftInstr("i64.shr_u", i64, BinaryOperator.SHIFT_RIGHT_UNSIGNED, Opcode.I64_SHRU) { a, b -> a.toLong().ushr(b) }
    val I64ShrS = ShiftInstr("i64.shr_s", i64, BinaryOperator.SHIFT_RIGHT_SIGNED, Opcode.I64_SHRS) { a, b -> a.toLong().shr(b) }
    ...
    val I64_ROTL = BinaryI64Instruction("i64.rotl", BinaryOperator.ROTATE_LEFT, Opcode.I64_ROTL) { a, b -> a.rotateLeft(b.toInt()) }

    val I32_ROTR = BinaryI32Instruction("i32.rotr", BinaryOperator.ROTATE_RIGHT, Opcode.I32_ROTR, Int::rotateRight)
    val I64_ROTR = BinaryI64Instruction("i64.rotr", BinaryOperator.ROTATE_RIGHT, Opcode.I64_ROTR) { a, b -> a.rotateRight(b.toInt()) }
