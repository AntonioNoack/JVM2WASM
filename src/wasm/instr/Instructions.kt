...
object Instructions {
    ...
    val I32_TRUNC_F32S = NumberCastInstruction("i32.trunc_f32_s", "static_cast<i32>(std::trunc(", "))", f32)
    val I32_TRUNC_F64S = NumberCastInstruction("i32.trunc_f64_s", "static_cast<i32>(std::trunc(", "))", f64)
    val I64_TRUNC_F32S = NumberCastInstruction("i64.trunc_f32_s", "static_cast<i64>(std::trunc(", "))", f32)
    val I64_TRUNC_F64S = NumberCastInstruction("i64.trunc_f64_s", "static_cast<i64>(std::trunc(", "))", f64)
    val F64_PROMOTE_F32 = NumberCastInstruction("f64.promote_f32", "static_cast<f64>(", ")", f32)
    val F32_DEMOTE_F64 = NumberCastInstruction("f32.demote_f64", "static_cast<f32>(", ")", f64)
    val I64_EXTEND_I32S = NumberCastInstruction("i64.extend_i32_s", "static_cast<i64>(", ")", i32)
    val I32_WRAP_I64 = NumberCastInstruction("i32.wrap_i64", "static_cast<i32>(", ")", i64)
    val F32_CONVERT_I32S = NumberCastInstruction("f32.convert_i32_s", "static_cast<f32>(", ")", i32)
    val F32_CONVERT_I64S = NumberCastInstruction("f32.convert_i64_s", "static_cast<f32>(", ")", i64)
    val F64_CONVERT_I32S = NumberCastInstruction("f64.convert_i32_s", "static_cast<f64>(", ")", i32)
    val F64_CONVERT_I64S = NumberCastInstruction("f64.convert_i64_s", "static_cast<f64>(", ")", i64)

    val F64_CONVERT_I32U = NumberCastInstruction("f64.convert_i32_u", "static_cast<f64>(", ")", i32)
    val F64_CONVERT_I64U = NumberCastInstruction("f64.convert_i64_u", "static_cast<f64>(", ")", i64)

    val I32_REINTERPRET_F32 = NumberCastInstruction("i32.reinterpret_f32", "std::bit_cast<i32>(", ")", f32)
    val F32_REINTERPRET_I32 = NumberCastInstruction("f32.reinterpret_i32", "std::bit_cast<f32>(", ")", i32)
    val I64_REINTERPRET_F64 = NumberCastInstruction("i64.reinterpret_f64", "std::bit_cast<i64>(", ")", f64)
    val F64_REINTERPRET_I64 = NumberCastInstruction("f64.reinterpret_i64", "std::bit_cast<f64>(", ")", i64)
