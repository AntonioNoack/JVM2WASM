...
public class LWJGLxOpenGL {
    ...
    public static native void org_lwjgl_opengl_GL30C_glBindFramebuffer_IIV(int mode, int framebuffer);
...
*/
    ...
    @NoThrow
    @Alias(name = "org_lwjgl_openal_AL_createCapabilities_Lorg_lwjgl_openal_ALCCapabilitiesLjava_util_IntFunctionLorg_lwjgl_openal_ALCapabilities")
