...
public class LWJGLxGLFW {
    ...
    @NoThrow
    @Alias(name = "org_lwjgl_glfw_GLFW_glfwInit_Z")
    public static boolean org_lwjgl_glfw_GLFW_glfwInit_Z() {
        return true;
    }

    @NoThrow
    @Alias(name = "org_lwjgl_glfw_GLFW_glfwGetWindowPos_JAIAIV")
    ...
    @NoThrow
    @Alias(name = "org_lwjgl_glfw_GLFW_glfwSetCursorPos_JDDV")
    ...
    @NoThrow
    @Alias(name = "org_lwjgl_glfw_GLFW_glfwSetInputMode_JIIV")
    ...
    @NoThrow
    @Alias(name = "org_lwjgl_glfw_GLFW_glfwGetWindowMonitor_JJ")
    ...
    @NoThrow
    @Alias(name = "org_lwjgl_glfw_GLFW_glfwCreateStandardCursor_IJ")
    public static long org_lwjgl_glfw_GLFW_glfwCreateStandardCursor_IJ(int id) {
        return id;
    }

    @Alias(name = "org_lwjgl_system_MemoryUtil_memAllocShort_ILjava_nio_ShortBuffer")
    public static ShortBuffer MemoryUtil_memAllocShort(int size) {
        return ShortBuffer.allocate(size);
    }

    @Alias(name = "org_lwjgl_system_MemoryUtil_memFree_Ljava_nio_BufferV")
    ...
    @NoThrow
    @JavaScript(code = "")
    @Alias(name = "org_lwjgl_glfw_GLFW_glfwSetCursor_JJV")
    public static native void org_lwjgl_glfw_GLFW_glfwSetCursor_JJV(long window, long cursor);

    @NoThrow
    @Alias(name = "org_lwjgl_glfw_GLFW_glfwWaitEventsTimeout_DV")
    public static void GLFW_glfwWaitEventsTimeout_DV(double timeout) {
    }

    @NoThrow
    @Alias(name = "org_lwjgl_glfw_GLFW_glfwSwapBuffers_JV")
    public static void GLFW_glfwSwapBuffers(long window) {
    }

    @NoThrow
    @Alias(name = "org_lwjgl_glfw_GLFW_glfwWindowShouldClose_JZ")
    public static boolean GLFW_glfwWindowShouldClose(long window) {
        return false;
    }

    @NoThrow
    @Alias(name = "org_lwjgl_glfw_GLFW_glfwSetWindowShouldClose_JZV")
    public static void GLFW_glfwSetWindowShouldClose(long window, boolean shouldClose) {
    }

    @NoThrow
    @Alias(name = "org_lwjgl_glfw_GLFW_glfwCreateWindow_IILjava_lang_CharSequenceJJJ")
    ...
    @NoThrow
    @Alias(name = "org_lwjgl_glfw_GLFW_glfwShowWindow_JV")
    public static void GLFW_glfwShowWindow(long window) {

    }

    @NoThrow
    @Alias(name = "org_lwjgl_glfw_GLFW_glfwMakeContextCurrent_JV")
    public static void GLFW_glfwMakeContextCurrent(long window) {

    }

    @NoThrow
    @Alias(name = "org_lwjgl_glfw_GLFW_glfwSwapInterval_IV")
    public static void GLFW_glfwSwapInterval(int interval) {

    }

    @NoThrow
    @Alias(name = "org_lwjgl_glfw_GLFW_glfwSetWindowPos_JIIV")
    public static void GLFW_glfwSetWindowPos(long window, int x, int y) {

    }

    @NoThrow
    @Alias(name = "org_lwjgl_glfw_GLFW_glfwWindowHint_IIV")
    public static void GLFW_glfwWindowHint(int key, int value) {

    }

    @NoThrow
    @Alias(name = "org_lwjgl_glfw_GLFW_glfwSetDropCallback_JLorg_lwjgl_glfw_GLFWDropCallbackILorg_lwjgl_glfw_GLFWDropCallback")
    public static GLFWDropCallback org_lwjgl_glfw_GLFW_glfwSetDropCallback(long window, GLFWDropCallbackI callback) {
        return null;
    }

    @NoThrow
    @Alias(name = "org_lwjgl_glfw_GLFW_glfwSetCharModsCallback_JLorg_lwjgl_glfw_GLFWCharModsCallbackILorg_lwjgl_glfw_GLFWCharModsCallback")
    ...
    @NoThrow
    @Alias(name = "org_lwjgl_glfw_GLFW_glfwSetCursorPosCallback_JLorg_lwjgl_glfw_GLFWCursorPosCallbackILorg_lwjgl_glfw_GLFWCursorPosCallback")
    ...
    @NoThrow
    @Alias(name = "org_lwjgl_glfw_GLFW_glfwSetMouseButtonCallback_JLorg_lwjgl_glfw_GLFWMouseButtonCallbackILorg_lwjgl_glfw_GLFWMouseButtonCallback")
    ...
    @NoThrow
    @Alias(name = "org_lwjgl_glfw_GLFW_glfwSetScrollCallback_JLorg_lwjgl_glfw_GLFWScrollCallbackILorg_lwjgl_glfw_GLFWScrollCallback")
    ...
    @NoThrow
    @Alias(name = "org_lwjgl_glfw_GLFW_glfwSetKeyCallback_JLorg_lwjgl_glfw_GLFWKeyCallbackILorg_lwjgl_glfw_GLFWKeyCallback")
    ...
    @NoThrow
    @Alias(name = "org_lwjgl_glfw_GLFW_glfwGetPrimaryMonitor_J")
    public static long org_lwjgl_glfw_GLFW_glfwGetPrimaryMonitor_J() {
        return 0L;
    }

    @NoThrow
    @Alias(name = "org_lwjgl_glfw_GLFW_glfwGetVideoMode_JLorg_lwjgl_glfw_GLFWVidMode")
    ...
    @Alias(name = "org_lwjgl_glfw_GLFW_nglfwGetFramebufferSize_JJJV")
    ...
    @NoThrow
    @Alias(name = "org_lwjgl_glfw_GLFW_glfwGetCursorPos_JADADV")
