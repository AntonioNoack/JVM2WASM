...
public class Chars {
    ...
    @NoThrow
    @Alias(name = "java_lang_Character_toUpperCase_II")
    ...
    @NoThrow
    @Alias(name = "java_lang_Character_toUpperCase_CC")
    ...
    @NoThrow
    @Alias(name = "java_lang_Character_toLowerCase_CC")
    ...
    @NoThrow
    @Alias(name = "java_lang_Character_toLowerCase_II")
    ...
    @NoThrow
    @Alias(name = "java_lang_Character_isLetterOrDigit_IZ")
