...
public class JavaLang {
    ...
    @NoThrow
    @Alias(name = "java_lang_ClassLoader_desiredAssertionStatus_Ljava_lang_StringZ")
    public static boolean desiredAssertionStatus(String s) {
        return false;
    }

    @NoThrow
    @Alias(name = "java_lang_Class_desiredAssertionStatus_Z")
    ...
    @Alias(name = "java_lang_Throwable_getStackTraceDepth_I")
    ...
    @Alias(name = "java_lang_Throwable_printStackTrace_V")
    public static native void java_lang_Throwable_printStackTrace_V(Throwable th);

    @NoThrow
    @Alias(name = "java_lang_Throwable_fillInStackTrace_Ljava_lang_Throwable")
    ...
    @Alias(name = "java_lang_Thread_getStackTrace_ALjava_lang_StackTraceElement")
    ...
    @NoThrow
    @Alias(name = "java_lang_System_registerNatives_V")
    public static void registerNatives() {
    }

    @NoThrow
    @Alias(name = "java_lang_Thread_registerNatives_V")
    public static void registerNatives2() {
    }

    @NoThrow
    @Alias(name = "java_lang_Thread_setPriority_IV")
    ...
    @NoThrow
    @Alias(name = "java_lang_Object_getClass_Ljava_lang_Class")
    public static int Object_getClass(int instance) {
        return findClass2(readClass(instance));
    }

    @Alias(name = "java_lang_Object_hashCode_I")
    public static int Object_hashCode(Object instance) {
        return getAddr(instance);
    }

    @Alias(name = "java_lang_Class_getPrimitiveClass_Ljava_lang_StringLjava_lang_Class")
    ...
    @Alias(name = "java_lang_Thread_currentThread_Ljava_lang_Thread")
    public static Thread Thread_currentThread() {
        if (thread == null) thread = new Thread("main");
        return thread;
    }

    @Alias(name = "AW_clone_Ljava_lang_Object")
    ...
    @Alias(name = "java_lang_System_setOut0_Ljava_io_PrintStreamV")
    ...
    @Alias(name = "java_lang_System_setErr0_Ljava_io_PrintStreamV")
    ...
    @NoThrow
    @Alias(name = "java_lang_Class_getClassLoader_Ljava_lang_ClassLoader")
    public static ClassLoader getClassLoader(Class<Object> clazz) {
        return cl;
    }

    @NoThrow
    @Alias(name = "java_lang_ClassLoader_getSystemClassLoader_Ljava_lang_ClassLoader")
    public static ClassLoader ClassLoader_getSystemClassLoader() {
        return cl;
    }

    @Alias(name = "java_lang_Thread_init_Ljava_lang_ThreadGroupLjava_lang_RunnableLjava_lang_StringJLjava_security_AccessControlContextZV")
    ...
    @Alias(name = "java_lang_Thread_interrupt0_V")
    public static void Thread_interrupt0(Thread th) {
    }

    @NoThrow
    @Alias(name = "java_lang_Class_getFields_ALjava_lang_reflect_Field")
    ...
    @Alias(name = "java_lang_Class_getDeclaredField_Ljava_lang_StringLjava_lang_reflect_Field")
    ...
    @Alias(name = "java_lang_Class_getDeclaredMethods_ALjava_lang_reflect_Method")
    public static <V> int Class_getDeclaredMethods(Class<V> clazz) {
        return read32(getAddr(clazz) + objectOverhead + 8);
    }

    @Alias(name = "java_lang_Class_getMethod_Ljava_lang_StringALjava_lang_ClassLjava_lang_reflect_Method")
    ...
    @Alias(name = "java_lang_Class_getDeclaredMethod_Ljava_lang_StringALjava_lang_ClassLjava_lang_reflect_Method")
    ...
    @Alias(name = "java_lang_Class_getCanonicalName_Ljava_lang_String")
    ...
    @Alias(name = "java_lang_reflect_Field_get_Ljava_lang_ObjectLjava_lang_Object")
    ...
    @Alias(name = "java_lang_reflect_Field_set_Ljava_lang_ObjectLjava_lang_ObjectV")
    ...
    @Alias(name = "java_lang_reflect_Field_setInt_Ljava_lang_ObjectIV")
    ...
    @Alias(name = "java_lang_reflect_Field_getInt_Ljava_lang_ObjectI")
    ...
    @Alias(name = "java_lang_Class_forName_Ljava_lang_StringZLjava_lang_ClassLoaderLjava_lang_Class")
    ...
    @Alias(name = "java_lang_Class_isArray_Z")
    public static <V> boolean Class_isArray(Class<V> clazz) {
        return clazz.getName().charAt(0) == '[';
    }

    @Alias(name = "java_lang_Class_getEnclosingClass_Ljava_lang_Class")
    ...
    @Alias(name = "java_lang_Class_isLocalClass_Z")
    public static <V> boolean java_lang_Class_isLocalClass_Z(Class<V> clazz) {
        return Class_getEnclosingClass(clazz) != null;
    }

    @Alias(name = "java_lang_System_getProperty_Ljava_lang_StringLjava_lang_String")
    ...
    @NoThrow
    @Alias(name = "java_lang_Class_checkMemberAccess_ILjava_lang_ClassZV")
    ...
    @NoThrow
    @Alias(name = "java_lang_Class_registerNatives_V")
    public static void java_lang_Class_registerNatives_V() {

    }

    @Alias(name = "java_lang_Class_isPrimitive_Z")
    ...
    @Alias(name = "java_lang_Class_getComponentType_Ljava_lang_Class")
    ...
    @NoThrow
    @Alias(name = "java_lang_String_intern_Ljava_lang_String")
    ...
    @Alias(name = "java_lang_Object_clone_Ljava_lang_Object")
    ...
    @Alias(name = "java_lang_management_ManagementFactory_getRuntimeMXBean_Ljava_lang_management_RuntimeMXBean")
    ...
    @Alias(name = "java_lang_Double_toString_DLjava_lang_String")
    ...
    @Alias(name = "java_lang_StringBuilder_append_FLjava_lang_StringBuilder")
    ...
    @Alias(name = "java_lang_AbstractStringBuilder_append_DLjava_lang_AbstractStringBuilder")
    ...
    @Alias(name = "java_lang_StringBuilder_append_DLjava_lang_StringBuilder")
    ...
    @Alias(name = "java_lang_Float_toString_FLjava_lang_String")
    public static String Float_toString(float f) {
        return Double_toString(f);
    }

    @Alias(name = "java_lang_Package_getSystemPackage0_Ljava_lang_StringLjava_lang_String")
    ...
    @Alias(name = "java_lang_System_getenv_Ljava_lang_StringLjava_lang_String")
    ...
    @Alias(name = "java_lang_Class_getSuperclass_Ljava_lang_Class")
    ...
    @Alias(name = "java_lang_ClassLoader_getResourceAsStream_Ljava_lang_StringLjava_io_InputStream")
    ...
    @Alias(name = "java_lang_Class_getDeclaredFields_ALjava_lang_reflect_Field")
    ...
    @Alias(name = "java_lang_Class_isAnonymousClass_Z")
    public static <V> boolean isAnonymousClass(Class<V> clazz) {
        return false;
    }

    @Alias(name = "kotlin_jvm_internal_ClassReference_getSimpleName_Ljava_lang_String")
    public static String ClassReference_getSimpleName(ClassReference c) {
        return c.getJClass().getSimpleName();
    }

    @Alias(name = "kotlin_reflect_jvm_internal_KClassImpl_getSimpleName_Ljava_lang_String")
    public static <V> String KClassImpl_getSimpleName(ClassBasedDeclarationContainer c) {
        return c.getJClass().getSimpleName();
    }

    @Alias(name = "java_lang_Class_getSimpleName_Ljava_lang_String")
    ...
    @Alias(name = "java_lang_Character_digit_III")
    ...
    @Alias(name = "java_lang_reflect_Field_equals_Ljava_lang_ObjectZ")
    ...
    @Alias(name = "java_lang_Class_toString_Ljava_lang_String")
    ...
    @Alias(name = "java_lang_Class_getAnnotations_ALjava_lang_annotation_Annotation")
    public static <V> Annotation[] java_lang_Class_getAnnotations_ALjava_lang_annotation_Annotation(Class<V> clazz) {
        // todo implement this properly
        return new Annotation[0];
    }

    @Alias(name = "java_lang_Class_isInstance_Ljava_lang_ObjectZ")
    ...
    @Alias(name = "java_lang_Thread_start_V")
    ...
    @NoThrow
    @Alias(name = "java_lang_Runtime_gc_V")
    @JavaScript(code = "gcCtr=1e9")
    public static native void java_lang_Runtime_gc_V(Runtime rt);

    @NoThrow
    @Alias(name = "java_lang_System_gc_V")
    @JavaScript(code = "gcCtr=1e9")
    public static native void java_lang_System_gc_V();

    @Alias(name = "java_lang_reflect_Array_newArray_Ljava_lang_ClassILjava_lang_Object")
    ...
    @NoThrow
    @Alias(name = "new_java_lang_ClassLoader_Ljava_lang_VoidLjava_lang_ClassLoaderV")
    ...
    @Alias(name = "java_lang_Runtime_exec_ALjava_lang_StringLjava_lang_Process")
    public static Process java_lang_Runtime_exec_ALjava_lang_StringLjava_lang_Process(Runtime rt, String[] args) {
        throw new RuntimeException("Starting processes is not possible in WASM");
    }

    @Alias(name = "java_lang_Runtime_exec_ALjava_lang_StringALjava_lang_StringLjava_io_FileLjava_lang_Process")
