...
public class JavaX {
    ...
    @Alias(name = "org_apache_logging_log4j_LoggerImpl_getTimeStamp_Ljava_lang_String")
    ...
    @Alias(name = "javax_vecmath_VecMathI18N_getString_Ljava_lang_StringLjava_lang_String")
